            ...
            <div class="p-6 mx-auto bg-white rounded-lg shadow-xl lg:w-1/2">
              <div class="flex flex-col items-start py-2 rounded-lg lg:flex-row">
                ...
                <div class="flex flex-col w-full text-blueGray-500 lg:ml-4">
                  <h2 class="mt-4 mb-2 text-xs font-semibold tracking-widest text-black uppercase lg:mt-0 title-font">{((issue.isUnder18)?"Under 18":"") } &nbsp; {((issue.isSingleParent)?"Single Parent":"")}</h2>
                  <h2 class="mb-4 text-xl font-semibold tracking-widest text-black uppercase lg:mt-0 title-font"> {issue.Title} </h2>
                  <p class="mb-3 text-base leading-relaxed text-blueGray-500"> {issue.Description}</p>
                <div class="flex flex-row space-x-2 items-center justify-left"><span class="mt-4 mb-2 text-xl font-semibold tracking-widest text-black uppercase lg:mt-0 title-font"> <GrIcons.GrMapLocation /></span>
                  <p class="mb-2 text-base leading-relaxed text-blueGray-500"> Location of Issue</p>
                </div>
